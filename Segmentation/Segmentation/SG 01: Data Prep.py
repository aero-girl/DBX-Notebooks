...
( spark
    .read
    .csv(
      '/mnt/completejourney/bronze/campaign_table.csv',
      header=True,
    ...
    .mode('overwrite')
    .option('overwriteSchema', 'true')
    .save('/mnt/completejourney/silver/campaigns_households')
  )
...
_ = spark.sql('''
    ...
    USING DELTA 
    LOCATION '/mnt/completejourney/silver/campaigns_households'
    ''')
...
( spark
    .read
    .csv(
      '/mnt/completejourney/bronze/causal_data.csv',
      header=True,
    ...
    .mode('overwrite')
    .option('overwriteSchema', 'true')
    .save('/mnt/completejourney/silver/causal_data')
  )
...
_ = spark.sql('''
    ...
    USING DELTA 
    LOCATION '/mnt/completejourney/silver/causal_data'
    ''')
