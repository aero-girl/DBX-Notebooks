...
household_X_pd = spark.table('DELTA.`/mnt/completejourney/silver/features_finalized/`').toPandas()
...
( 
  spark # bring together household and cluster ids
    ...
    .save('/mnt/completejourney/gold/household_clusters/')
  )
...
try:
  spark.sql('ALTER TABLE DELTA.`/mnt/completejourney/gold/household_clusters/` ADD COLUMN (hc_cluster integer)')
except:
  pass  
...
deltaTable = DeltaTable.forPath(spark, '/mnt/completejourney/gold/household_clusters/')
